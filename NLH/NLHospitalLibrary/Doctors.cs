...
namespace NLHospitalLibrary
{
    ...
    public class Doctors
    {
        ...
        public string oDocId;

        public string oSpeciality;
        public Doctors()
        {
            //
        ...
        public string AddData(string ID, string LN, string FN, string spec)
        {
            ...
            try
            {
                ...
                {
                    sMsg = "Doctor " + ID + " already present in database. Please choose another ID!";
                }
        ...
        public string UpdateData(string ID, string LN, string FN, string spec)
        {
            ...
            try
            {
                ...
                m_oDA.Update(thisDataSet, "Doctors");
                sMsg = "Record was updated sucessfully!";
        ...
        public void GetDoctorInfo(string doc_ID)
        {
            DataSet DoctDataSet = new DataSet();
            DoctDataSet = FindData(doc_ID);

            oFirstName = DoctDataSet.Tables["Doctors"].Rows[0]["FirstName"].ToString();
            oLastName = DoctDataSet.Tables["Doctors"].Rows[0]["LastName"].ToString();
            oSpeciality = DoctDataSet.Tables["Doctors"].Rows[0]["Specialty"].ToString();
        }
