...
namespace NLHospitalLibrary
{
    ...
    public class Patients
    {
        ...
        public Patients()
        {
            ...
            oInsCmd.Parameters.Add(new SqlParameter("@DateOfBirth", SqlDbType.NVarChar, 8, "DateOfBirth"));
            ...
            oInsCmd.Parameters.Add(new SqlParameter("@Doctor", SqlDbType.NChar, 4, "Doctor"));
        ...
        public string AddData(string LN, string FN, string health, DateTime dob,
            ...
            string insCo, string insNum, string kin, string kinRel, string doc)
        {
            ...
            try
            {
                ...
                thisDataSet.Tables["Patients"].Rows[0]["DateOfBirth"] = birth;
